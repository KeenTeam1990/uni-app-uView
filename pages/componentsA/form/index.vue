<template>
	<view class="wrap">
		<u-form :model="model" :rules="rules" ref="uForm" :errorType="errorType">
			...
			<u-form-item :leftIconStyle="{color: '#888', fontSize: '32rpx'}" left-icon="account" label-width="120" :label-position="labelPosition" label="密码" prop="password">
				<u-input :border="border" placeholder="请输入密码" v-model="model.password" type="password"></u-input>
			</u-form-item>
